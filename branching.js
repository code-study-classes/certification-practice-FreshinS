...
export const findMiddleNumber = (n1, n2, n3) => {
  if (((n1 >= n2) && (n1 <= n3)) || ((n1 <= n2) && (n1 >= n3))) return n1;
  if (((n2 >= n1) && (n2 <= n3)) || ((n2 <= n1) && (n2 >= n3))) return n2;
  if (((n3 >= n2) && (n3 <= n1)) || ((n3 <= n2) && (n3 >= n1))) return n3;
  return 0;
};

export const findUniqueNumber = (n1, n2, n3, n4) => {
  if ((n1 !== n2) && (n1 !== n3) && (n1 !== n4)) return 1;
  if ((n2 !== n1) && (n2 !== n3) && (n2 !== n4)) return 2;
  if ((n3 !== n2) && (n3 !== n1) && (n3 !== n4)) return 3;
  if ((n4 !== n2) && (n4 !== n3) && (n4 !== n1)) return 4;
  return 0;
};
